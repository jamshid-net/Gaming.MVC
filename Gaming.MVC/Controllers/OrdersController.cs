...
namespace UserIdentitySolution.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderId,OrderDate,Quantity,UserId,ProductId")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("OrderId,OrderDate,Quantity,UserId,ProductId")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
